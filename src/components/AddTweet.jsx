...
const AddTweet = () => {
  ...
  return (
    <>
      <div className='h-auto border border-gray-300 dark:text-white dark:border-gray-500'>
        <div className='flex justify-between px-3 mt-3'>
          <h2 className='font-sans text-xl font-bold'>Home</h2>
          <button onClick={() => handleIsDark()}>
            <svg className='hover:bg-gray-200 dark:bg-white cursor-pointer px-2 rounded-full' viewBox="0 0 24 24" width="30px" height="30px" aria-hidden="true" class="r-18jsvk2 dark:fill-white r-4qtqp9 r-yyyyoo r-z80fyv r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-19wmn03"><g><path d="M22.772 10.506l-5.618-2.192-2.16-6.5c-.102-.307-.39-.514-.712-.514s-.61.207-.712.513l-2.16 6.5-5.62 2.192c-.287.112-.477.39-.477.7s.19.585.478.698l5.62 2.192 2.16 6.5c.102.306.39.513.712.513s.61-.207.712-.513l2.16-6.5 5.62-2.192c.287-.112.477-.39.477-.7s-.19-.585-.478-.697zm-6.49 2.32c-.208.08-.37.25-.44.46l-1.56 4.695-1.56-4.693c-.07-.21-.23-.38-.438-.462l-4.155-1.62 4.154-1.622c.208-.08.37-.25.44-.462l1.56-4.693 1.56 4.694c.07.212.23.382.438.463l4.155 1.62-4.155 1.622zM6.663 3.812h-1.88V2.05c0-.414-.337-.75-.75-.75s-.75.336-.75.75v1.762H1.5c-.414 0-.75.336-.75.75s.336.75.75.75h1.782v1.762c0 .414.336.75.75.75s.75-.336.75-.75V5.312h1.88c.415 0 .75-.336.75-.75s-.335-.75-.75-.75zm2.535 15.622h-1.1v-1.016c0-.414-.335-.75-.75-.75s-.75.336-.75.75v1.016H5.57c-.414 0-.75.336-.75.75s.336.75.75.75H6.6v1.016c0 .414.335.75.75.75s.75-.336.75-.75v-1.016h1.098c.414 0 .75-.336.75-.75s-.336-.75-.75-.75z"></path></g></svg>
          </button>
        </div>
        <div className="flex px-5 gap-3 items-center">
          <div><img src="https://picsum.photos/70/70" className='rounded-full' alt="" /></div>
          <textarea name="" placeholder='What`s happening?' className='w-full px-4 py-5 text-2xl font-semibold mt-2 placeholder:text-black dark:placeholder:text-white dark:bg-gray-800 dark:rounded-md'  id="" cols="30" rows="1"></textarea>
        </div>
        <div className='flex items-center justify-between'>
          <div className='flex p-3 ml-16 gap-3'>
            <svg width="24" height="24" fill='skyblue' viewBox="0 0 24 24" aria-hidden="true" className="r-1cvl2hr r-4qtqp9 r-yyyyoo r-z80fyv r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-19wmn03"><g><path d="M19.75 2H4.25C3.01 2 2 3.01 2 4.25v15.5C2 20.99 3.01 22 4.25 22h15.5c1.24 0 2.25-1.01 2.25-2.25V4.25C22 3.01 20.99 2 19.75 2zM4.25 3.5h15.5c.413 0 .75.337.75.75v9.676l-3.858-3.858c-.14-.14-.33-.22-.53-.22h-.003c-.2 0-.393.08-.532.224l-4.317 4.384-1.813-1.806c-.14-.14-.33-.22-.53-.22-.193-.03-.395.08-.535.227L3.5 17.642V4.25c0-.413.337-.75.75-.75zm-.744 16.28l5.418-5.534 6.282 6.254H4.25c-.402 0-.727-.322-.744-.72zm16.244.72h-2.42l-5.007-4.987 3.792-3.85 4.385 4.384v3.703c0 .413-.337.75-.75.75z"></path><circle cx="8.868" cy="8.309" r="1.542"></circle></g></svg>
          ...
          <div className='flex p-3 mr-10'>
            <button type='submit' className='px-6 py-2 bg-sky-400 rounded-full text-white font-semibold'>Tweet</button>
          </div>
        </div>
      </div>
    </>
